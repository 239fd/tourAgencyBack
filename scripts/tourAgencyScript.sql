CREATE SCHEMA IF NOT EXISTS `touragency` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `touragency` ;
...
CREATE TABLE IF NOT EXISTS `touragency`.`orders_has_languages` (
                                                                   ...
                                                                   INDEX `fk_orders_has_languages_languages1_idx` (`languages_id` ASC) VISIBLE,
                                                                   INDEX `fk_orders_has_languages_orders_idx` (`orders_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `touragency`.`tours_has_languages` (
                                                                  ...
                                                                  INDEX `fk_tours_has_languages_languages1_idx` (`languages_id` ASC) VISIBLE,
                                                                  INDEX `fk_tours_has_languages_tours1_idx` (`tours_id` ASC) VISIBLE,
